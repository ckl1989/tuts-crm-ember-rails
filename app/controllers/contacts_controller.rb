class ContactsController < ApplicationController
  ...
  def create
    ...
    @contact.projects = relationship_params[:project] || []
  ...
  private
    ...
    def contact_params
      params.require(:data).require(:attributes).permit(:family_name, :given_names, :company, :title, :phone, :email, :website, :address, :customer_id, :additional_info)
    end
end
