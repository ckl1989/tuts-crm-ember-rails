...
ActiveRecord::Schema.define(version: 20170201062312) do
  ...
  create_table "contacts_offers", force: :cascade do |t|
    ...
    t.integer "offers_id"
    t.index ["contacts_id"], name: "index_contacts_offers_on_contacts_id"
    t.index ["offers_id"], name: "index_contacts_offers_on_offers_id"
  end
